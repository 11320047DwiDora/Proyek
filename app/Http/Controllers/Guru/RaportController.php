...
class RaportController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('page.guru.raport.input', ['raport' => new Raport, 'course' => $course, 'room'=> $room,'user'=>$user,'task'=>$task]);
    }
    ...
    public function edit()
    {
        ...
        $task = Task::get();
        $user = User::where('role','s')->get();
        return view('page.guru.raport.input', ['task' => $task, 'course' => $course, 'room'=> $room,'user'=>$user,'raport'=>$raport]);
    }
