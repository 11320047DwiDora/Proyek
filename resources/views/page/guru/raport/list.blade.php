<table class="table table-rounded table-striped border gy-7 gs-7">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a title="Perbarui" data-bs-toggle="tooltip" data-bs-placement="top" href="javascript:;" onclick="load_input('{{route('guru.raport.input',$item->id)}}');" class="btn btn-icon btn-warning"><i class="las la-edit fs-2"></i></a>
