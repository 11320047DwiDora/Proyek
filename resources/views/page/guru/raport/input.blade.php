                    ...
                    <div class="row mb-7">
                            ...
                            <div class="mb-10">
                                ...
                                <select data-control="select2" data-placeholder="Pilih Pelajaran" name="courses_id" class="form-select form-select-solid">
                                    ...
                                    @foreach ($course as $item)
                                        <option value="{{$item->id}}" {{$raport->course_id == $item->id ? 'selected' : ''}}>{{$item->nama_course}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="mb-10">
                                ...
                                <select data-control="select2" data-placeholder="Pilih Kelas" name="kelas_id" class="form-select form-select-solid">
                                    ...
                                    @foreach ($room as $item)
                                        <option value="{{$item->id}}" {{$item->class_id == $item->id ? 'selected' : ''}}>{{$item->nama_kelas}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-10">
                                ...
                                <input type="text" id="kehadiran" name="kehadiran" class="form-control form-control-solid" placeholder="Kehadiran" value="{{$raport->kehadiran}}"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <div class="mb-10">
                                <label for="url" class="required form-label">Nilai Tugas</label>
                                <input type="text" id="tugas" name="tugas" class="form-control form-control-solid" placeholder="Nilai Tugas" value="{{$raport->tugas}}"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <div class="mb-10">
                                <label for="url" class="required form-label">Nilai UTS</label>
                                <input type="text" id="uts" name="uts" class="form-control form-control-solid" placeholder="Nilai UTS" value="{{$raport->uts}}"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <div class="mb-10">
                                <label for="url" class="required form-label">Nilai UAS</label>
                                <input type="text" id="uas" name="uas" class="form-control form-control-solid" placeholder="Nilai UAS" value="{{$raport->uas}}"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <div class="mb-10">
                                <label for="url" class="required form-label">KKM</label>
                                <input type="text" id="kkm" name="kkm" class="form-control form-control-solid" placeholder="KKM" value="{{$raport->kkm}}"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <div class="mb-10">
                                <label for="url" class="required form-label">Nilai Akhir</label>
                                <input type="text" id="nilai_akhir" name="nilai_akhir" class="form-control form-control-solid" placeholder="Nilai Akhir" value="{{$raport->nilai_akhir}}"/>
                            </div>
                        </div>
                        <div class="min-w-150px text-end">
                            @if ($raport->id)
                            <button id="tombol_simpan"
                              onclick="handle_upload('#tombol_simpan','#form_input','{{ route('guru.raport.update', $raport->id) }}','PATCH','Simpan');"
                              class="btn btn-primary">Simpan</button>
                          @else
                            <button id="tombol_simpan"
                              onclick="handle_upload('#tombol_simpan','#form_input','{{ route('guru.raport.store') }}','POST','Simpan');"
                              class="btn btn-primary">Simpan</button>
                          @endif
                        </div>
                        <!--end::Col-->
